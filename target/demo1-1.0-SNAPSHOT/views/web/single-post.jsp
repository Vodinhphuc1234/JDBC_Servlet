            ...
            <div class="col-md-offset-1 col-md-10 col-sm-12">
                <div class="blog-single-post-thumb">
                    ...
                    <div class="blog-post-title">
                        <h2><a>We Help You Create Perfect Modern Design</a></h2>
                    </div>
                    ...
                    <div class="blog-post-des">
                        ...
                        <div class="blog-post-image">
                            <img src="<c:url value='/template/web/images/blog-image3.jpg'/>" class="img-responsive"
                                 alt="Blog Image 3">
                        </div>

                        <h3>What is Personal Blog Theme?</h3>
                        <p>Nulla tincidunt eu velit elementum accumsan. Vivamus euismod tempor interdum. Vivamus non
                            scelerisque ex, et interdum leo. In bibendum lacus vitae felis egestas, at consectetur metus
                            facilisis. Morbi tellus dolor, porta dignissim enim sit amet, dapibus sagittis erat. In
                            blandit elit sit amet dui aliquet congue nec vel quam. Integer id tristique libero.</p>
                    </div>
                    ...
                    <div class="blog-single-post-image">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <img src="<c:url value='/template/web/images/blog-image2.jpg'/>" class="img-responsive"
                                 alt="Blog Image 2">
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <img src="<c:url value='/template/web/images/blog-image3.jpg'/>" class="img-responsive"
                    ...
                    <p>Aliquam blandit velit nisi, sed fringilla felis lacinia sed. Integer vitae porta felis. Class
                        ...
                        non tristique lacus. Suspendisse ut tortor vitae risus lacinia tristique. Aliquam sed
                        consectetur libero.</p>

                    <div class="blog-author">
                        <div class="media">
                            <div class="media-object pull-left">
                                <img src="<c:url value='/template/web/images/author-image1.jpg'/>"
                    ...
                    <div class="blog-comment">
                        ...
                        <div class="media">
                            <div class="media-object pull-left">
                                <img src="<c:url value='/template/web/images/comment-image1.jpg'/>"
                        ...
                        <div class="media">
                            <div class="media-object pull-left">
                                <img src="<c:url value='/template/web/images/comment-image2.jpg'/>"
                                     class="img-responsive img-circle" alt="Blog Image 22">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="media-object pull-left">
                                <img src="<c:url value='/template/web/images/author-image2.jpg'/>"
                                     class="img-responsive img-circle" alt="Blog Image 33">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="media-object pull-left">
                                <img src="<c:url value='/template/web/images/author-image1.jpg'/>"
                                     class="img-responsive img-circle" alt="Blog Image 44">
                            </div>
                            <div class="media-body">
